...
occupied:   {bg:'#f9a8d4', border:'#ec4899', numColor:'#ffffff', dimColor:'#831843'},
uncleaned:  {bg:'#f87171', border:'#dc2626', numColor:'#ffffff', dimColor:'#7f1d1d'},
cleaning:   {bg:'#fcd34d', border:'#f59e0b', numColor:'#1c1200', dimColor:'#3d2800'},
inspection: {bg:'#a78bfa', border:'#7c3aed', numColor:'#ffffff', dimColor:'#3b0764'},
vacant:     {bg:'#4ade80', border:'#16a34a', numColor:'#022c16', dimColor:'#052e16'},
broken:     {bg:'#fb923c', border:'#ea580c', numColor:'#ffffff', dimColor:'#7c2d12'},
cleaned:    {bg:'#a78bfa', border:'#7c3aed', numColor:'#ffffff', dimColor:'#3b0764'},
};
